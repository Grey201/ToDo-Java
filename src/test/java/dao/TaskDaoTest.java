...
//  }
    ...
    public void testSaveSetsId() {
        Task task = new Task("test task for productStar leson", false, LocalDateTime.now());
        taskDao.save(task);
    ...
    public void testGetByIdReturnsCorrectTask() {
        ...
        LocalDateTime truncatedToMicros = now.truncatedTo(ChronoUnit.MICROS);
        Task task = new Task("test task", false, truncatedToMicros);
        taskDao.save(task);
    ...
    public void testFindNotFinishedReturnsCorrectTasks() {
        LocalDateTime now = LocalDateTime.now();
        LocalDateTime truncatedToMicros = now.truncatedTo(ChronoUnit.MICROS);
        Task unfinishedTask = new Task("test task", false, truncatedToMicros);
